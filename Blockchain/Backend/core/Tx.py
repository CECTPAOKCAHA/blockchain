...
PRIVATE_KEY = '70823506017701540561203866717631079497878760118292554073560863947506823146285'
MINER_ADDRESS = '14o47Abc1BtCtqoAutJGakcd1gx9MhwMam'
SIGNHASH_ALL = 1
...
class Tx:
    ...
    def is_coinbase(self):
        ...
        # grab the 1st input and check if the prev_tx is b'\x00' * 32
    ...
    def to_dict(self):
        ...
        for tx_index, tx_in in enumerate(self.tx_ins):
            if self.is_coinbase():
                tx_in.script_sig.cmd[0] = little_endian_to_int(tx_in.script_sig.cmds[0])
